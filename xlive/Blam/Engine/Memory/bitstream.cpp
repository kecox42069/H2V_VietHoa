...
{	
	typedef void(__thiscall* begin_writing_t)(bitstream*, DWORD, char, char);
	auto p_begin_writing_def = Memory::GetAddress<begin_writing_t>(0xD24F5, 0xCEAAF);
...
void bitstream::finish_writing(void* out_space_left_in_bits)
{
	...
	auto p_finish_writing_def = Memory::GetAddress<finish_writing_t>(0xD1205, 0xCD7BF);
...
{
	typedef void(__thiscall* data_encode_string_t)(bitstream*, char*, void*, int);
...
{
	typedef void(__thiscall* data_decode_string_t)(bitstream*, char*, void*, int);
...
{
	typedef void(__thiscall* data_encode_integer_t)(bitstream*, char*, unsigned int, signed int);
...
{
	typedef int(__thiscall* data_decode_integer_t)(bitstream*, char*, int);
...
{
	typedef void(__thiscall* data_encode_bits_t)(bitstream*, char*, void*, int);
...
{
	typedef void(__thiscall* data_decode_bits_t)(bitstream*, char*, void*, int);
...
{
	typedef void(__thiscall* data_encode_bool_t)(bitstream*, char*, bool);
...
{
	typedef bool(__thiscall* data_decode_bool_t)(bitstream*, char*);
...
{
	typedef void(__thiscall* data_decode_address_t)(bitstream*, char*, void*);
...
{
	typedef void(__thiscall* data_encode_quantized_real_t)(bitstream*, char*, float, float, float, int, char);
	auto p_data_encode_quantized_real_def = Memory::GetAddress<data_encode_quantized_real_t>(0xD1B9B, 0xCE155);
...
{
	typedef float(__thiscall* data_decode_quantized_real_t)(bitstream*, char*, float, float, int, char);
	auto p_data_decode_quantized_real_def = Memory::GetAddress<data_decode_quantized_real_t>(0xD2039, 0xCE5F3);
...
{
	typedef void(__thiscall* data_encode_unit_vector_t)(bitstream*, char*, real_vector3d*);
	auto p_data_encode_unit_vector_def = Memory::GetAddress<data_encode_unit_vector_t>(0xD1BD9,0xCE193);
	p_data_encode_unit_vector_def(this, name, vector);
}

void bitstream::data_decode_unit_vector(char* name, real_vector3d* out_vector)
{
	typedef void(__thiscall* data_decode_unit_vector_t)(bitstream*, char*, real_vector3d*);
	auto p_data_decode_unit_vector_def = Memory::GetAddress<data_decode_unit_vector_t>(0xD20F4,0xCE6AE);
...
{
	typedef void(__thiscall* data_encode_signed_integer_t)(bitstream*, char*, signed int, signed int);
	auto p_data_encode_signed_integer_def = Memory::GetAddress<data_encode_signed_integer_t>(0xD183B, 0xCDDF5);
...
{
	typedef void(__thiscall* data_encode_axes_t)(bitstream*, char*, real_vector3d*, real_vector3d*);
	auto p_data_encode_axes_def = Memory::GetAddress<data_encode_axes_t>(0xD1D41, 0xCE2FB);
...
{
	typedef void(__thiscall* data_decode_axes_t)(bitstream*, char*, real_vector3d*, real_vector3d*);
	auto p_data_decode_axes_def = Memory::GetAddress<data_decode_axes_t>(0xD21DB, 0xCE795);
...
{
	typedef void(__thiscall* data_encode_vector_t)(bitstream*, char*, real_vector3d *, float , float , int );
	auto p_data_encode_vector_def = Memory::GetAddress<data_encode_vector_t>(0xD1C4B, 0xCE205);
...
{
	typedef void(__thiscall* data_decode_vector_t)(bitstream*, char*, real_vector3d *, float, float, int);
	auto p_data_decode_vector_def = Memory::GetAddress<data_decode_vector_t>(0xD210C, 0xCE6C6);
...
{
	typedef void(__thiscall* data_encode_flags_t)(bitstream*, char*, unsigned long long, int);
	auto p_data_encode_flags_def = Memory::GetAddress<data_encode_flags_t>(0xD171D, 0xCDCD7);
...
{
	typedef unsigned long long(__thiscall* data_decode_flags_t)(bitstream*, char*, int);
	auto p_data_decode_flags_def = Memory::GetAddress<data_decode_flags_t>(0xD1E9A, 0xCE454);
	return p_data_decode_flags_def(this, name, size_in_bits);
}

bool bitstream::overflow()
{
	typedef bool(__thiscall* overflow_t)(bitstream* thisx);
